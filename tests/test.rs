...
tests! {
    ...
    jump6: ("tests/jumps/break_nest.c", 12),
    jump7: ("tests/jumps/break_multiple.c", 4),
    jump8: ("tests/jumps/continue_for.c", 30),
    jump9: ("tests/jumps/continue_while.c", 30),
    jump10: ("tests/jumps/continue_dowhile.c", 30),
