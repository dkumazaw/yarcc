...
tests! {
    ...
    break0: ("tests/jumps/break_for.c", 4),
    break1: ("tests/jumps/break_while.c", 6),
    break2: ("tests/jumps/break_dowhile.c", 24),
    break3: ("tests/jumps/break_nest.c", 12),
    break4: ("tests/jumps/break_multiple.c", 4),
    continue0: ("tests/jumps/continue_for.c", 30),
    continue1: ("tests/jumps/continue_while.c", 30),
    continue2: ("tests/jumps/continue_dowhile.c", 30),
    continue3: ("tests/jumps/continue_nest.c", 150),
    continue4: ("tests/jumps/continue_multiple.c", 17),
