...
tests! {
    ...
    break0: ("tests/ctests/break_for.c", 4),
    break1: ("tests/ctests/break_while.c", 6),
    break2: ("tests/ctests/break_dowhile.c", 24),
    break3: ("tests/ctests/break_nest.c", 12),
    break4: ("tests/ctests/break_multiple.c", 4),
    continue0: ("tests/ctests/continue_for.c", 30),
    continue1: ("tests/ctests/continue_while.c", 30),
    continue2: ("tests/ctests/continue_dowhile.c", 30),
    continue3: ("tests/ctests/continue_nest.c", 150),
    continue4: ("tests/ctests/continue_multiple.c", 17),
