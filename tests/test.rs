...
tests! {
    ...
    jump0: ("int main() { return 1;} ", 1),
    jump1: ("int main() { return (3 + 1) *  10;} ", 40),
    jump2: ("int main() { int a; a = 4 + 5; return a + 1;} ", 10),
    jump3: ("int main() { return 5; return 1; 2;} ", 5),
    jump4: ("tests/jumps/break_for.c", 4),
    jump5: ("tests/jumps/break_while.c", 6),
    jump6: ("tests/jumps/break_dowhile.c", 24),
    jump7: ("tests/jumps/break_nest.c", 12),
    jump8: ("tests/jumps/break_multiple.c", 4),
    jump9: ("tests/jumps/continue_for.c", 30),
    jump10: ("tests/jumps/continue_while.c", 30),
    jump11: ("tests/jumps/continue_dowhile.c", 30),
    jump12: ("tests/jumps/continue_nest.c", 150),
    jump13: ("tests/jumps/continue_multiple.c", 17),
